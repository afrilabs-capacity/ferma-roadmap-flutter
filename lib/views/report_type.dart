...
import 'package:lac/views/report_menu_pdss.dart';
              ...
              child: SingleChildScrollView(
                child: Column(
                    ...
                    children: <Widget>[
                      ...
                      QuickMenu(),
                      Divider(),
                      Text("Select report type to continue",style: TextStyle(color: siteThemeColor),),
                      SizedBox(height: 30,),
                          ...
                          builder:(context,child,user)=>
                              RaisedButton(
                                ...
                                onPressed: ()=>  Navigator.push(
                                  context,
                                  CupertinoPageRoute(builder: (context) => ReportMenuDaily()),
                                ),
                                child: Container(
                                  decoration: BoxDecoration(
                        ...
                        builder: (context) => Consumer<AuthProvider>(
                          builder:(context,child,user)=>
                              RaisedButton(
                                ...
                                onPressed: ()=> Navigator.push(
                                  context,
                                  CupertinoPageRoute(builder: (context) => ReportMenuPdss()),
                                ),
                                child: Container(
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(12),

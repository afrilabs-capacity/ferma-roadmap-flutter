  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
          ...
          appBar: AppBar(
            title: Text('Daily Reports',style: TextStyle(color: siteThemeColor),),
                            ...
                            child: Consumer<ReportProvider>(
                              ...
                              !data.apiCallModal ? Row(
                                ...
                                children: [
                                  RaisedButton(
                                      onPressed: ()async{
                                        var delete=  await Provider.of<ReportProvider>(context,listen: false).deleteReport(reportId: reportId);
                                        //print(reportId);

                                        if(delete['success']){
                                          Provider.of<ReportProvider>(context, listen: false).fetchReports().then((value) => Navigator.pop(context));
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 8.0,),
                              Text('State: ',style: TextStyle(fontWeight: FontWeight.bold,color: siteThemeColor)),
                              Flexible(child: Text('${data.reports[index].location['name']}',)),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: [
                                ...
                                children: <Widget>[
                                  Text('CaseType: ',style: TextStyle(fontWeight: FontWeight.bold,color: siteThemeColor)),
                                  Flexible(child: Text( '${data.reports[index].caseType}',style: TextStyle(color: siteThemeColor),))
                                ],
                              )),
                                   ...
                                   onTap: ()=>Navigator.push(
                                     context,
                                     CupertinoPageRoute(builder: (context) => ReportSingle(report:data.reports[index])),
                                   ),
...
//    TextEditingController passwordController =TextEditingController(text: '1234567');
  ...
  void initState() {
    ...
    WidgetsBinding.instance
      ...
      await Provider.of<ReportProvider>(context,listen: false).fetchReports().then((value){
        Provider.of<ReportProvider>(context,listen: false).showFilter=false;
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child:  Text("Search by First Name, Last Name or State",style: TextStyle(color: siteIconThemeLight), textAlign: TextAlign.left,),
                        ...
                        child: DropdownButton(
                          ...
                          selectedItemBuilder: (BuildContext context) {
                            return myState.states.map<Widget>((item) {
                              return SizedBox(width: 70, child: Center(child: Text(item.state, )));
                            }).toList();
                          },
...
//                    isExpanded:true,
//                    //underline: Text(''),
//                    icon: Icon(Icons.keyboard_arrow_down,color: siteIconThemeLight,),
//                    //underline: Container(color:data.dropDownValidation_1, height:1.0),
//                    hint: Text('State',style: TextStyle(color: siteIconThemeLight)),
//                    value: data.selectedState,
//                    selectedItemBuilder: (BuildContext context) {
//                      return myState.states.map((value) {
//                        return Text(
//                          value.state,
//                          style: TextStyle(color: Colors.white),
//                        );
...
//                    Text(value.state,style: TextStyle(color: siteIconThemeDark),),value:value.id.toString(),)  ).toList(),

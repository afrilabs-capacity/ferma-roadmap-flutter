...
import 'package:lac/views/reports_pdss.dart';
import 'package:lac/views/add_report_pdss.dart';
import 'package:lac/views/news.dart';
import 'package:lac/views/home.dart';
import 'package:lac/views/feedback.dart';

class ReportMenuPdss extends StatelessWidget {
            ...
            child: Center(
              child: SingleChildScrollView(
                child: Column(
                    ...
                    children: <Widget>[
                      Text("PDSS Report Menu",style: TextStyle(color: siteThemeColor,fontSize: 22),),
                      SizedBox(height: 30,),
                      Divider(),
                      QuickMenu(),
                      Divider(),
                          ...
                          builder:(context,child,user)=>
                              RaisedButton(
                                ...
                                onPressed: ()=>  Navigator.push(
                                  context,
                                  CupertinoPageRoute(builder: (context) => AddReportPdss()),
                                ),
                                child: Container(
                                  decoration: BoxDecoration(
                        ...
                        builder: (context) => Consumer<AuthProvider>(
                          builder:(context,child,user)=>
                              RaisedButton(
                                ...
                                onPressed: ()=> Navigator.push(
                                  context,
                                  CupertinoPageRoute(builder: (context) => ReportsPdss()),
                                ),
                                child: Container(
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(12),
